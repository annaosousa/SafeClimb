...
class SearchFragment : Fragment() {
    ...
    private fun setUpPopularMountainsRecyclerView() {
        // Lista de itens para montanhas populares
        val popularMountains = listOf(
            Item("Pico do Paraná", "Montanha mais popular"),
            Item("Pico do Marumbi", "Outra montanha popular"),
    ...
    private fun setUpBestViewRecyclerView() {
        val items = listOf(
            Item("Pico do Paraná", "Descrição da montanha 1"),
            Item("Pico do Caratuva", "Descrição da montanha 2"),
            Item("Morro do Anhangava", "Descrição da montanha 3")
        )
