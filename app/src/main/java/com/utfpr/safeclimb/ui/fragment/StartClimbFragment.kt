...
import com.utfpr.safeclimb.databinding.FragmentStartClimbBinding
...
class StartClimbFragment : Fragment() {
    ...
    private fun getTmpFileUri(): Uri {
        ...
        return FileProvider.getUriForFile(
            requireContext(),
            "com.utfpr.safeclimb.fileprovider",
            tempPicture
        )
    }
    ...
    fun saveImageToGallery(sourceImageUri: Uri, displayName: String): Uri? {
        ...
        val contentValues = ContentValues().apply {
            ...
            put(MediaStore.Images.Media.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + File.separator + "SafeClimb_" + FirstActivity.getEmail())
        }
